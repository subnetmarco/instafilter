...
public class ColoredEdgeFilter extends BaseFilter {
	...
	protected void doFilter(BufferedImage image, OutputStream output,
		...
		com.jhlabs.image.BumpFilter bumpFilter = new com.jhlabs.image.BumpFilter();
		bumpFilter.filter(image, outputImage);
